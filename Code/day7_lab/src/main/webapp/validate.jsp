...
public void jspInit(){
	...
	//populate the map
	users.put("rushi@gmail.com", new User("Rushikesh","pass123",LocalDate.parse("2001-11-23"),"rushi@gmail.com"));
...
boolean validateUser(){
	...
	{
		User userToValidate = users.get(email);
		
		if(userToValidate.getPassword().equals(password))
			return true;
		else
			return false;
	}else{
