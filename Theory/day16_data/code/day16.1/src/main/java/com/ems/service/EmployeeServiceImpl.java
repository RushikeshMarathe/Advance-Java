...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
	public String addNewEmployeeDetails(Employee newEmployee) {
		
		if(employeeDao.existsByEmail(newEmployee.getEmail()))
		{
			return "Employee with "+newEmployee.getEmail()+" already exists!..";
		}else {
			employeeDao.save(newEmployee);
			return "Employee "+newEmployee.getFirstName()+" added successfully!...";
		}
	}
